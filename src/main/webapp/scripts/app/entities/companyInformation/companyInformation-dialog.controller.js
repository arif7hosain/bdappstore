...
angular.module('appstoreApp').controller('CompanyInformationDialogController',
    ['$scope', '$stateParams', '$uibModalInstance', '$q', 'DataUtils', 'entity', 'CompanyInformation', 'Country', 'ServiceCategory', 'User',
        function($scope, $stateParams, $uibModalInstance, $q, DataUtils, entity, CompanyInformation, Country, ServiceCategory, User) {
